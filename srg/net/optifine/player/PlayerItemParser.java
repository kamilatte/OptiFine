...
public class PlayerItemParser {
  ...
  public static PlayerItemRenderer parseItemRenderer(JsonObject elem, Dimension textureDim) {
    ...
    ModelPlayerItem modelPlayerItem = new ModelPlayerItem(RenderType::entityCutoutNoCull);
    ((Model)modelPlayerItem).textureWidth = textureDim.width;
    ((Model)modelPlayerItem).textureHeight = textureDim.height;
    ModelPart mr = parseModelRenderer(elem, (Model)modelPlayerItem, null, null);
