...
public class ModelAdapterDonkey extends ModelAdapterHorse {
  ...
  public Model makeModel() {
    return (Model)new ChestedHorseModel(bakeModelLayer(ModelLayers.DONKEY));
  }
  ...
  public IEntityRenderer makeEntityRender(Model modelBase, float shadowSize, RendererCache rendererCache, int index) {
    ...
    ChestedHorseRenderer render = new ChestedHorseRenderer(renderManager.getContext(), 0.87F, ModelLayers.DONKEY);
