...
public class RandomEntityProperties<T> {
  ...
  public RandomEntityProperties(String path, akr baseLoc, int[] variants, RandomEntityContext<T> context) {
  ...
  public RandomEntityProperties(Properties props, String path, akr baseResLoc, RandomEntityContext<T> context) {
  ...
  private RandomEntityRule<T>[] parseRules(Properties props, String pathProps, akr baseResLoc) {
  ...
  public static net.optifine.RandomEntityProperties parse(akr propLoc, akr resLoc, RandomEntityContext<?> context) {
    String contextName = context.getName();
    try {
      String path = propLoc.a();
      Config.dbg(contextName + ": " + contextName + ", properties: " + resLoc.a());
