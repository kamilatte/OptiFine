...
public class LightMapPack {
  ...
  public boolean updateLightmap(fzf world, float torchFlickerX, faj lmColorsImage, boolean nightvision, float darkLight, float partialTicks) {
    int lmColorsLength = lmColorsImage.a() * lmColorsImage.b();
  ...
  public boolean updateLightmap(fzf world, float torchFlickerX, int[] lmColors, boolean nightvision, float darkLight, float partialTicks) {
    ...
    if (WorldUtils.isEnd((dcw)world) || WorldUtils.isNether((dcw)world))
      return this.lightMap.updateLightmap(world, torchFlickerX, lmColors, nightvision, darkLight); 
