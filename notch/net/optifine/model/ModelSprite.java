...
public class ModelSprite {
  ...
  public ModelSprite(fyk modelRenderer, float textureOffsetX, float textureOffsetY, float posX, float posY, float posZ, int sizeX, int sizeY, int sizeZ, float sizeAdd) {
  ...
  public void render(fbi matrixStackIn, fbm bufferIn, int packedLightIn, int packedOverlayIn, int colorIn) {
    float scale = 0.0625F;
  ...
  public static void renderItemIn2D(fbi matrixStackIn, fbm bufferIn, float minU, float minV, float maxU, float maxV, int sizeX, int sizeY, float width, float texWidth, float texHeight, int packedLightIn, int packedOverlayIn, int colorIn) {
    if (width < 6.25E-4F)
      width = 6.25E-4F; 
    float dU = maxU - minU;
    float dV = maxV - minV;
    float dimX = ayo.e(dU) * texWidth / 16.0F;
    float dimY = ayo.e(dV) * texHeight / 16.0F;
    float normX = 0.0F;
    float normY = 0.0F;
    float normZ = -1.0F;
  ...
  static void addVertex(fbi matrixStackIn, fbm bufferIn, float x, float y, float z, int colorIn, float texU, float texV, int overlayUV, int lightmapUV, float normalX, float normalY, float normalZ) {
    fbi.a matrixEntry = matrixStackIn.c();
    Matrix4f matrix4f = matrixEntry.a();
    ...
    bufferIn.a(xt, yt, zt, colorIn, texU, texV, overlayUV, lightmapUV, xn, yn, zn);
  }
}
