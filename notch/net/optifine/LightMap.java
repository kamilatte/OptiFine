...
public class LightMap {
  ...
  public boolean updateLightmap(fzf world, float torchFlickerX, int[] lmColors, boolean nightvision, float darkLight) {
    ...
    float gamma = Config.limitTo1((float)((Double)Config.getGameSettings().ap().c()).doubleValue());
