...
public class ShadowFrustum extends gie {
  ...
  private void extendForShadows(Matrix4f matrixIn, Matrix4f projectionIn) {
    fzf world = (Config.getMinecraft()).r;
    if (world == null)
      return; 
    ...
    float sx = -ayo.a(sar);
    float sy = ayo.b(sar) * ayo.b(sunTiltRad);
    float sz = -ayo.b(sar) * ayo.a(sunTiltRad);
    ...
    float farPlaneDistance = Config.getGameRenderer().k();
    ...
    float eyeHeight = (int)(Config.getMinecraft()).s.dx();
